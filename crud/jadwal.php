  ...
  <div class="container">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Form Data Jadwal</h5>
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="tmata_kuliah" value="<?= $data['mata_kuliah']?>" placeholder="Masukkan Mata Kuliah Anda">
            </div>

            <div class="mb-3">
                <label class="form-label">WAKTU</label>
                <input type="text" class="form-control" name="twaktu" value="<?= $data['waktu']?>" placeholder="Masukkan Waktu Kuliah">
            </div>

            <div class="mb-3">
                <label class="form-label">RUANG</label>
                <input type="text" class="form-control" name="truang" value="<?= $data['ruang']?>" placeholder="Masukkan RUANG Anda">
            </div>   
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
          ...
          <span class="text-danger"><?= $data['mata_kuliah']?> - <?= $data['mata_kuliah']?></span>
         </h5>  
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="mb-3">
                <label class="form-label">MATA KULIAH</label>
                <input type="text" class="form-control" name="tmata_kuliah" placeholder="Masukkan Mata Kuliah Anda">
            </div>

            <div class="mb-3">
                <label class="form-label">WAKTU</label>
                <input type="text" class="form-control" name="twaktu" placeholder="Masukkan Waktu Anda">
            </div>

            <div class="mb-3">
             <label class="form-label">RUANG</label> 
             <input type="text" class="form-control" name="truang" placeholder="Masukkan Ruang Anda">
            </div>    
        </div>
